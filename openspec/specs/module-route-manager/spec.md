# Capability: Module Route Manager

## Purpose

Manages commercial modules and their associated API routes, and enforces access control so that only tenants with active module contracts can access the corresponding endpoints.
